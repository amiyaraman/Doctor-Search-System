...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<MyErrorResponse> CityExceptionHandler(CityException e){
        MyErrorResponse errorResponse=new MyErrorResponse(HttpStatus.BAD_REQUEST,e.getMessage(),e.getCause().getMessage());
        return new ResponseEntity<>(errorResponse,errorResponse.getStatus());
    }
    ...
    ResponseEntity<MyErrorResponse> noDoctorExceptionHandler(NoDoctorException e){
        MyErrorResponse errorResponse=new MyErrorResponse(HttpStatus.NOT_FOUND,e.getMessage(),e.getCause().getMessage());
        return new ResponseEntity<>(errorResponse,errorResponse.getStatus());
    }
